...
function NoiseCanvas() {
  ...
  return <canvas ref={canvasRef} className="Signup_noise" />;
}
...
export default function SignupPage() {
  ...
  return (
    <main className="Signup_wrap">
      <NoiseCanvas />
      <div className="padding-global Signup_body">
        <div className="container-1400 w-container Signup_container">
          <div className="Signup_card">
            <DottedFrame />
            <Link href="/" className="Signup_brand Signup_reveal Signup_reveal-2">
              <span className="ts-14px color-white mono all-caps">Sayso</span>
            </Link>

            <div key={step} className="Signup_step">
              {step === "email" ? (
                <>
                  <h1 className="ts-16px color-white Signup_title Signup_reveal Signup_reveal-3">
                    Sign in or create an account
                  </h1>
                  <p className="ts-14px color-white-50 Signup_sub Signup_reveal Signup_reveal-4">
                    Continue with Google, or use your email.
                  </p>

                  <button
                    type="button"
                    className="cta-button Signup_google Signup_reveal Signup_reveal-5"
                  ...
                  <div className="Signup_divider Signup_reveal Signup_reveal-6">
                  ...
                  >
                    ...
                    <button type="submit" className="cta-button is--blue Signup_submit">
                      Continue
                    </button>
                  </form>
                </>
                ...
                <>
                  ...
                  <form
                    className="Signup_form Signup_reveal Signup_reveal-4"
                    onSubmit={(e) => {
                      e.preventDefault();
            ...
            <p className="ts-14px color-white-50 Signup_footer Signup_reveal Signup_reveal-8">
      ...
      <div className="footer_copyright Signup_copyright">
        ©2026 Copyright Sayso. All rights reserved
      </div>

      <style>{`
        @keyframes SignupGlowIn {
          from {
            opacity: 0;
          }
          to {
        ...
        .Signup_wrap::before {
          ...
          opacity: 0;
          animation: SignupGlowIn 1.4s ease-out 0.1s forwards;
        }
        ...
        .Signup_card {
          animation: SignupCardIn 0.7s cubic-bezier(0.16, 1, 0.3, 1) both;
        }
        ...
        .Signup_reveal {
          animation: SignupRevealIn 0.5s cubic-bezier(0.16, 1, 0.3, 1) both;
        }

        .Signup_reveal-1 { animation-delay: 0.05s; }
        .Signup_reveal-2 { animation-delay: 0.1s; }
        .Signup_reveal-3 { animation-delay: 0.15s; }
        .Signup_reveal-4 { animation-delay: 0.2s; }
        .Signup_reveal-5 { animation-delay: 0.25s; }
        .Signup_reveal-6 { animation-delay: 0.3s; }
        .Signup_reveal-7 { animation-delay: 0.35s; }
        .Signup_reveal-8 { animation-delay: 0.4s; }
        ...
        .Signup_divider::before,
        .Signup_divider::after {
          content: "";
          flex: 1;
          height: 1px;
